...
client_list_lookup_by_inaddr(const struct module_instance * client_list,
			     in_addr_t cmp_addr);
...
void
client_list_clear(struct module_instance * client_list);
...
client_list_foreach(struct module_instance * client_list,
		    ...
		    void * arg);
void
client_list_remove(struct module_instance * client);

int
client_list_empty(struct module_instance * client_list);
